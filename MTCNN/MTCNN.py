...
## r_model_path in get_Onet_train_data.py
...
if __name__ == '__main__':
    ...
    input_folder_path = 'C:/Users/htxqteam/Documents/lprnet_pytorch/ANPR/Semantic-Guided-LL'
    # Create the output_folder_path if it doesn't exist
    output_folder_path = "C:/Users/htxqteam/Documents/lprnet_pytorch/ANPR-Cropped/Semantic-Guided-LL"
    ...
    for filename in os.listdir(input_folder_path):
        if filename.endswith(".jpg") or filename.endswith(".jpeg") or filename.endswith(".png"):
            ...
            "test image path", default=image_path, type=str)
            parser.add_argument("--scale", dest='scale', help=
            "scale the image", default=1, type=int)
            ...
            crop_img = cv2.resize(crop_img, (0, 0), fx = 1/args.scale, fy = 1/args.scale, interpolation=cv2.INTER_CUBIC)
            print(image_path)
            print(output_folder_path + filename[:-4] + "_cropped.jpg")


            output_path = os.path.join(output_folder_path, filename[:-4] + "_cropped.jpg")  # create output file path
